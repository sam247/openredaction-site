      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white text-black rounded-lg p-8 border-2 border-white relative">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2">For production applications</p>
              </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gray-900 rounded-lg p-8 border border-gray-800 max-w-2xl mx-auto">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-400">
                  ...
                  Pro tier keys (prefixed with `paid_`) have a limit of 10,000 requests per day. 
