...
| `GITHUB_TOKEN` | GitHub personal access token for contact form submissions | Yes (for contact form) |
| `GITHUB_REPO` | GitHub repository for form submissions (format: owner/repo) | No (defaults to sam247/openredaction-site) |
